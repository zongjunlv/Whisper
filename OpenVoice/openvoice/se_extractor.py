...
model = None
def split_audio_whisper(audio_path, audio_name, target_dir='processed', cache_dir=None):
    global model
    if model is None:
...
def get_se(audio_path, vc_model, target_dir='processed', vad=True, cache_dir=None):
    ...
    if cache_dir is None:
        ...
        if vad:
            ...
            wavs_folder = split_audio_whisper(audio_path, target_dir=target_dir, audio_name=audio_name, cache_dir=cache_dir)
